...
/**
 * Class that implements a Point in a 2Dplano.
 * The coordenadas are doubles;
 *
 * @author  MaterialPOO
 * @version 2k19
 */
public class Point
{
  ...
  /**
   * Constructors of Class Point.
   * Declaration of the constructors by omission(empty),
   * params, copy
   */

  /**
   * Construtor by omission of a point
   */
  public Point()
  {
    this.x = 0;
  ...
  /**
   * Constructor of point params
   * Take as argument the values of each coordinate
   */
  ...
  /**
   * Copy of the constructor Point.
   * Accept as argument the values of a Point
   * and uses is instances
   */
  public Ponto(Ponto aPoint)
  {
    this.x = aPoint.getX();
    this.y = aPoint.getY();
  }
  ...
  /**
   * returns the value of the coordinate X
   *
   * @return value of x.
   */
  public int getX()
