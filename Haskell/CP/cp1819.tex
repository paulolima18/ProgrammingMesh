...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathbf{data}\;\Conid{Tipo}\mathrel{=}\Conid{V}\mid \Conid{Vd}\mid \Conid{Ve}\mid \Conid{H}\mid \Conid{Ht}\mid \Conid{Hb}\;\mathbf{deriving}\;\Conid{Show}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{inExpr}\mathrel{=}\alt{\Conid{Num}}{\Varid{bop'}}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{bop'}\;(\Varid{o},(e_1 ,e_2 ))\mathrel{=}\Conid{Bop}\;e_1 \;\Varid{o}\;e_2 {}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{recExpr}\;\Varid{f}\mathrel{=}\Varid{id}+(\Varid{id}\times(\Varid{f}\times\Varid{f})){}\<[E]%
\\[\blanklineskip]%
...
Estas funções, nomeadamente \ensuremath{\Varid{inExpr}}, \ensuremath{\Varid{outExpr}},
\ensuremath{\Varid{recExpr}}, \ensuremath{\Varid{cataExpr}}, \ensuremath{\Varid{anaExpr}} e \ensuremath{\Varid{hyloExpr}}, podem ser
...
Uma vez que uma Expr é um \ensuremath{\Conid{Num}\;\Conid{Int}} ou \ensuremath{\Conid{Bop}\;\Conid{Expr}\;\Conid{Op}\;\Conid{Expr}}
sabemos que o \ensuremath{\Varid{inExpr}} e o \ensuremath{\Varid{outExpr}} deverão "construir" ou "desconstruir"
...
\begin{eqnarray*}
\start
\ensuremath{\Varid{inExpr}\mathrel{=}\alt{\Conid{Num}}{\Varid{bop'}}}
      \ensuremath{\mathbf{where}\;\Varid{bop'}\;(\Varid{o},(e_1 ,e_2 ))\mathrel{=}\Conid{Bop}\;e_1 \;\Varid{o}\;e_2 }
\end{eqnarray*}
\begin{eqnarray*}
\start
\ensuremath{\Varid{outExpr}\;(\Conid{Num}\;\Varid{a})\mathrel{=}i_1\;(\Varid{a})}
\more
\ensuremath{\Varid{outExpr}\;(\Conid{Bop}\;e_1 \;\Varid{o}\;e_2 )\mathrel{=}i_2\;(\Varid{o},(e_1 ,e_2 ))}
\end{eqnarray*}


Quanto às restantes funções, \ensuremath{\Varid{recExpr}}, \ensuremath{\Varid{cataExpr}},
\ensuremath{\Varid{anaExpr}} e \ensuremath{\Varid{hyloExpr}}, estas foram deduzidas através do diagrama
que podemos observar infra.
A título de exemplo, assumimos que as funções \ensuremath{\Varid{g}} e \ensuremath{\Varid{h}} são a função identidade

\begin{eqnarray*}
\xymatrix@C=3cm{
   \ensuremath{\Conid{Expr}}
          \ar[d]_-{\ensuremath{\Varid{anaExpr}\;\Varid{g}}}
           \ar[r]^-{\ensuremath{\Varid{g}}}
&
   \ensuremath{\Conid{Int}\mathbin{+}(\Conid{Op}\times(\Conid{Expr}\times\Conid{Expr})}
          \ar[d]^{\ensuremath{\Varid{recExpr}\;(\Varid{anaExpr}\;\Varid{g})}}
\\
    \ensuremath{\Conid{Expr}}
       \ar[d]_-{\ensuremath{\Varid{cataExpr}\;\Varid{h}}}
       \ar[r]^-{\ensuremath{\Varid{outExpr}}}
&
    \ensuremath{\Conid{Int}\mathbin{+}(\Conid{Op}\times(\Conid{Expr}\times\Conid{Expr})}
          \ar[l]^-{\ensuremath{\Varid{inExpr}}}
           \ar[d]^{\ensuremath{\Varid{recExpr}\;(\Varid{cataExpr}\;\Varid{h})}}
\\
   \ensuremath{\Conid{Expr}}
&
   \ensuremath{\Conid{Int}\mathbin{+}(\Conid{Op}\times(\Conid{Expr}\times\Conid{Expr})}
...
\begin{eqnarray*}
\start
\ensuremath{\Varid{recExpr}\;\Varid{f}\mathrel{=}\Varid{id}\mathbin{+}(\Varid{id}\times(\Varid{f}\times\Varid{f}))}
\more
\ensuremath{\Varid{cataExpr}\;\Varid{h}\mathrel{=}\Varid{h}\comp (\Varid{recExpr}\;(\Varid{cataExpr}\;\Varid{h}))\comp \Varid{outExpr}}
\more
\ensuremath{\Varid{anaExpr}\;\Varid{g}\mathrel{=}\Varid{inExpr}\comp (\Varid{recExpr}\;(\Varid{anaExpr}\;\Varid{g}))\comp \Varid{g}}
\more
\ensuremath{\Varid{hyloExpr}\;\Varid{h}\;\Varid{g}\mathrel{=}\Varid{cataExpr}\;\Varid{h}\comp \Varid{anaExpr}\;\Varid{g}}
\end{eqnarray*}
...
\begin{enumerate}
\item Função \ensuremath{\Varid{calcula}}

O objetivo da função \ensuremath{\Varid{calcula}} é calcular o valor de uma expressão, pelo que o
seu diagrama é:

\begin{eqnarray*}
\xymatrix@C=2cm{
    \ensuremath{\Conid{Expr}}
           \ar[d]_-{\ensuremath{\Varid{cataExpr}\;\Varid{g}}}
&
    \ensuremath{\Conid{Int}\mathbin{+}(\Conid{Op}\times(\Conid{Expr}\times\Conid{Expr})}
           \ar[d]^{\ensuremath{\Varid{recExpr}\;(\Varid{cataExpr}\;\Varid{g})}}
...
algo do género \ensuremath{\Varid{calcula}\mathrel{=}\Varid{cataExpr}\;\Varid{g}}.

Observando a expressão que obtemos após a aplicação do functor \ensuremath{\Varid{recExpr}} e sabendo
que o resultado final terá de ser o calculo da expressão em causa,
deduzimos que o \ensuremath{\Varid{g}} terá que ser um ``either'', \ensuremath{\Varid{g}\mathrel{=}\alt{\Varid{id}}{\Varid{junta}}}.
Assim, do lado direito irá devolver o \ensuremath{\Conid{Int}} e do outro tratar \ensuremath{(\Conid{Op}\times(\Conid{Int}\times\Conid{Int})},
consoante a operação aritmética em causa.
Desta feita, a função \ensuremath{\Varid{calcula}} é:
...
\\
\>[B]{}\Varid{calcula}\;\Varid{e}\mathrel{=}\Varid{cataExpr}\;\alt{\Varid{id}}{\Varid{junta}}\;\Varid{e}{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\mathbf{where}\;\Varid{junta}\;(\Conid{Op}\;\Varid{op},(\Varid{n1},\Varid{n2}))\mid \Varid{op}\equiv \text{\ttfamily \char34 +\char34}\mathrel{=}\Varid{n1}\mathbin{+}\Varid{n2}{}\<[E]%
\\
\>[9]{}\hsindent{27}{}\<[36]%
\>[36]{}\mid \Varid{op}\equiv \text{\ttfamily \char34 -\char34}\mathrel{=}\Varid{n1}\mathbin{-}\Varid{n2}{}\<[E]%
\\
\>[9]{}\hsindent{27}{}\<[36]%
\>[36]{}\mid \Varid{op}\equiv \text{\ttfamily \char34 *\char34}\mathrel{=}\Varid{n1}\mathbin{*}\Varid{n2}{}\<[E]%
\\
\>[9]{}\hsindent{27}{}\<[36]%
\>[36]{}\mid \Varid{op}\equiv \text{\ttfamily \char34 /\char34}\mathrel{=}\Varid{n1}\mathbin{\Varid{`div`}}\Varid{n2}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks

\item Função \ensuremath{\Varid{compile}}
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{calculation}\mathbin{::}\Conid{String}\to \Conid{String}{}\<[E]%
\\
\>[B]{}\Varid{calculation}\;\text{\ttfamily \char34 +\char34}\mathrel{=}\text{\ttfamily \char34 ADD\char34}{}\<[E]%
\\
\>[B]{}\Varid{calculation}\;\text{\ttfamily \char34 *\char34}\mathrel{=}\text{\ttfamily \char34 MULT\char34}{}\<[E]%
\\
\>[B]{}\Varid{calculation}\;\text{\ttfamily \char34 -\char34}\mathrel{=}\text{\ttfamily \char34 MINUS\char34}{}\<[E]%
\\
\>[B]{}\Varid{calculation}\;\text{\ttfamily \char34 /\char34}\mathrel{=}\text{\ttfamily \char34 DIV\char34}{}\<[E]%
\\
\>[B]{}\Varid{calculation}\;{}\<[15]%
\>[15]{}\anonymous {}\<[19]%
\>[19]{}\mathrel{=}\text{\ttfamily \char34 UNDEFINED\char34}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{compile}\mathbin{::}\Conid{String}\to \Conid{Codigo}{}\<[E]%
\\
\>[B]{}\Varid{compile}\mathrel{=}\Varid{cataList}\;\alt{\Varid{nil}}{\Varid{compila}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{compila}\;(\Varid{x},\Varid{xs})\mathrel{=}\bot {}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\commentbegin 
...
right = Right (Op "3",(Num 10,Num 1)) \commentend}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks

\item Função \ensuremath{\Varid{show'}}

Esta função gera a representação textual de uma \ensuremath{\Conid{Expr}}, sendo o seu retorno
uma \ensuremath{\Conid{String}}
...
\\
\>[B]{}\Varid{show'}\mathrel{=}\Varid{cataExpr}\;\alt{\Varid{show}}{\Varid{expressao}}{}\<[E]%
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}\mathbf{where}\;\Varid{expressao}\;(\Conid{Op}\;\Varid{op},(\Varid{a},\Varid{b}))\mathrel{=}\text{\ttfamily \char34 (\char34}\plus \Varid{a}\plus \text{\ttfamily \char34 ~\char34}\plus \Varid{op}\plus \text{\ttfamily \char34 ~\char34}\plus \Varid{b}\plus \text{\ttfamily \char34 )\char34}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{inL2D}\mathrel{=}\alt{\Conid{Unid}}{\Varid{uncurryComp}}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{uncurryComp}\;(\Varid{b},(\Varid{x1},\Varid{x2}))\mathrel{=}\Conid{Comp}\;\Varid{b}\;\Varid{x1}\;\Varid{x2}{}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{recL2D}\;\Varid{f}\mathrel{=}\Varid{id}+(\Varid{id}\times(\Varid{f}\times\Varid{f})){}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  o a será uma lista de caixas}{}\<[E]%
\\
\>[B]{}\Varid{collectLeafs}\mathbin{::}\Conid{X}\;\Varid{a}\;\Varid{b}\to [\mskip1.5mu \Varid{a}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{collectLeafs}\;(\Conid{Unid}\;\Varid{a})\mathrel{=}[\mskip1.5mu \Varid{a}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{collectLeafs}\;(\Conid{Comp}\;\Varid{b}\;\Varid{x1}\;\Varid{x2})\mathrel{=}\Varid{collectLeafs}\;\Varid{x1}\plus \Varid{collectLeafs}\;\Varid{x2}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{myex1},\Varid{myex2},\Varid{myex3},\Varid{myex4}\mathbin{::}\Conid{L2D}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{myex1}\mathrel{=}\Conid{Unid}\;((\mathrm{100},\mathrm{300}),(\text{\ttfamily \char34 F\char34},\Varid{col\char95 green})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{myex2}\mathrel{=}\Conid{Comp}\;\Conid{Ve}\;\Varid{b1}\;\Varid{b2}{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\mathbf{where}\;\Varid{b1}\mathrel{=}\Conid{Unid}\;((\mathrm{100},\mathrm{300}),(\text{\ttfamily \char34 F\char34},\Varid{col\char95 green})){}\<[E]%
\\
\>[9]{}\hsindent{6}{}\<[15]%
\>[15]{}\Varid{b2}\mathrel{=}\Conid{Unid}\;((\mathrm{200},\mathrm{300}),(\text{\ttfamily \char34 H\char34},\Varid{col\char95 green})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{myex3}\mathrel{=}\Conid{Comp}\;\Conid{Hb}\;(\Conid{Comp}\;\Conid{Ve}\;\Varid{b1}\;\Varid{b2})\;(\Conid{Comp}\;\Conid{Ve}\;\Varid{b3}\;\Varid{b4}){}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\mathbf{where}\;\Varid{b1}\mathrel{=}\Conid{Unid}\;((\mathrm{100},\mathrm{300}),(\text{\ttfamily \char34 F\char34},\Varid{col\char95 green})){}\<[E]%
\\
...
\\
\>[9]{}\hsindent{6}{}\<[15]%
\>[15]{}\Varid{b3}\mathrel{=}\Conid{Unid}\;((\mathrm{300},\mathrm{300}),(\text{\ttfamily \char34 E\char34},\Varid{col\char95 green})){}\<[E]%
\\
\>[9]{}\hsindent{6}{}\<[15]%
\>[15]{}\Varid{b4}\mathrel{=}\Conid{Unid}\;((\mathrm{400},\mathrm{300}),(\text{\ttfamily \char34 G\char34},\Varid{col\char95 green})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{myex4}\mathrel{=}\Conid{Comp}\;\Conid{Hb}\;(\Conid{Comp}\;\Conid{Ve}\;\Varid{b1}\;\Varid{b2})\;(\Varid{b3}){}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\mathbf{where}\;\Varid{b1}\mathrel{=}\Conid{Unid}\;((\mathrm{100},\mathrm{300}),(\text{\ttfamily \char34 F\char34},\Varid{col\char95 green})){}\<[E]%
\\
...
\\
\>[9]{}\hsindent{6}{}\<[15]%
\>[15]{}\Varid{b3}\mathrel{=}\Conid{Unid}\;((\mathrm{300},\mathrm{300}),(\text{\ttfamily \char34 G\char34},\Varid{col\char95 green})){}\<[E]%
\\
\>[B]{}\Varid{ex3}\mathbin{::}\Conid{L2D}{}\<[E]%
\\
\>[B]{}\Varid{ex3}\mathrel{=}\Conid{Comp}\;\Conid{Hb}\;(\Conid{Comp}\;\Conid{Ve}\;\Varid{bot}\;\Varid{top})\;(\Conid{Comp}\;\Conid{Ve}\;\Varid{gbox2}\;\Varid{ybox2}){}\<[E]%
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}\mathbf{where}\;\Varid{bbox1}\mathrel{=}\Conid{Unid}\;((\mathrm{100},\mathrm{200}),(\text{\ttfamily \char34 A\char34},\Varid{col\char95 blue})){}\<[E]%
\\
\>[7]{}\hsindent{6}{}\<[13]%
\>[13]{}\Varid{bbox2}\mathrel{=}\Conid{Unid}\;((\mathrm{150},\mathrm{200}),(\text{\ttfamily \char34 E\char34},\Varid{col\char95 blue})){}\<[E]%
\\
\>[7]{}\hsindent{6}{}\<[13]%
\>[13]{}\Varid{gbox1}\mathrel{=}\Conid{Unid}\;((\mathrm{50},\mathrm{50}),(\text{\ttfamily \char34 B\char34},\Varid{col\char95 green})){}\<[E]%
\\
\>[7]{}\hsindent{6}{}\<[13]%
\>[13]{}\Varid{gbox2}\mathrel{=}\Conid{Unid}\;((\mathrm{100},\mathrm{300}),(\text{\ttfamily \char34 F\char34},\Varid{col\char95 green})){}\<[E]%
\\
\>[7]{}\hsindent{6}{}\<[13]%
\>[13]{}\Varid{rbox1}\mathrel{=}\Conid{Unid}\;((\mathrm{300},\mathrm{50}),(\text{\ttfamily \char34 C\char34},\Varid{col\char95 green})){}\<[E]%
\\
\>[7]{}\hsindent{6}{}\<[13]%
\>[13]{}\Varid{rbox2}\mathrel{=}\Conid{Unid}\;((\mathrm{200},\mathrm{100}),(\text{\ttfamily \char34 G\char34},\Varid{col\char95 green})){}\<[E]%
\\
\>[7]{}\hsindent{6}{}\<[13]%
\>[13]{}\Varid{wbox1}\mathrel{=}\Conid{Unid}\;((\mathrm{450},\mathrm{200}),(\text{\ttfamily \char34 \char34},\Varid{col\char95 green})){}\<[E]%
\\
\>[7]{}\hsindent{6}{}\<[13]%
\>[13]{}\Varid{ybox1}\mathrel{=}\Conid{Unid}\;((\mathrm{100},\mathrm{200}),(\text{\ttfamily \char34 D\char34},\Varid{col\char95 green})){}\<[E]%
\\
\>[7]{}\hsindent{6}{}\<[13]%
\>[13]{}\Varid{ybox2}\mathrel{=}\Conid{Unid}\;((\mathrm{100},\mathrm{300}),(\text{\ttfamily \char34 H\char34},\Varid{col\char95 green})){}\<[E]%
\\
\>[7]{}\hsindent{6}{}\<[13]%
\>[13]{}\Varid{bot}\mathrel{=}\Conid{Comp}\;\Conid{Hb}\;\Varid{wbox1}\;\Varid{bbox2}{}\<[E]%
\\
\>[7]{}\hsindent{6}{}\<[13]%
\>[13]{}\Varid{top}\mathrel{=}(\Conid{Comp}\;\Conid{Ve}\;(\Conid{Comp}\;\Conid{Hb}\;\Varid{bbox1}\;\Varid{gbox1})\;(\Conid{Comp}\;\Conid{Hb}\;\Varid{rbox1}\;(\Conid{Comp}\;\Conid{H}\;\Varid{ybox1}\;\Varid{rbox2}))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  é o ponto final do LD2, i e, o ponto onde começa a ultima caixa}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{v}\mathbin{::}\Conid{Int}\to \Conid{Int}\to \Conid{Int}{}\<[E]%
\\
\>[B]{}\Varid{v}\;\Varid{l1}\;\Varid{l2}\mid \Varid{l1}\geq \Varid{l2}\mathrel{=}\Varid{l1}{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\mid \Varid{otherwise}\mathrel{=}\Varid{l1}\mathbin{+}(\Varid{l2}\mathbin{\Varid{`div`}}\mathrm{2}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{calcAux}\mathbin{::}\Conid{Tipo}\to (\Conid{Int},\Conid{Int})\to (\Conid{Int},\Conid{Int})\to (\Conid{Int},\Conid{Int}){}\<[E]%
\\
\>[B]{}\Varid{calcAux}\;\Conid{V}\;(\Varid{l1},\Varid{a1})\;(\Varid{l2},\Varid{a2})\mathrel{=}(\Varid{v}\;\Varid{l1}\;\Varid{l2},\Varid{a1}\mathbin{+}\Varid{a2}){}\<[E]%
\\
\>[B]{}\Varid{calcAux}\;\Conid{Vd}\;(\Varid{l1},\Varid{a1})\;(\Varid{l2},\Varid{a2})\mathrel{=}(\Varid{max}\;\Varid{l1}\;\Varid{l2},\Varid{a1}\mathbin{+}\Varid{a2}){}\<[E]%
\\
\>[B]{}\Varid{calcAux}\;\Conid{Ve}\;(\Varid{l1},\Varid{a1})\;(\Varid{l2},\Varid{a2})\mathrel{=}(\Varid{max}\;\Varid{l1}\;\Varid{l2},\Varid{a1}\mathbin{+}\Varid{a2}){}\<[E]%
\\
\>[B]{}\Varid{calcAux}\;\Conid{Hb}\;(\Varid{l1},\Varid{a1})\;(\Varid{l2},\Varid{a2})\mathrel{=}(\Varid{l1}\mathbin{+}\Varid{l2},\Varid{max}\;\Varid{a1}\;\Varid{a2}){}\<[E]%
\\
\>[B]{}\Varid{calcAux}\;\Conid{Ht}\;(\Varid{l1},\Varid{a1})\;(\Varid{l2},\Varid{a2})\mathrel{=}(\Varid{l1}\mathbin{+}\Varid{l2},\Varid{a1}\mathbin{+}\Varid{a2}){}\<[E]%
\\
\>[B]{}\Varid{calcAux}\;\Conid{H}\;(\Varid{l1},\Varid{a1})\;(\Varid{l2},\Varid{a2})\mathrel{=}(\Varid{l1}\mathbin{+}\Varid{l2},\Varid{v}\;\Varid{a1}\;\Varid{a2}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{dimen}\mathbin{::}\Conid{X}\;\Conid{Caixa}\;\Conid{Tipo}\to (\Conid{Int},\Conid{Int}){}\<[E]%
\\
\>[B]{}\Varid{dimen}\;(\Conid{Unid}\;((\Varid{largura},\Varid{altura}),\anonymous ))\mathrel{=}(\Varid{largura},\Varid{altura}){}\<[E]%
\\
\>[B]{}\Varid{dimen}\;(\Conid{Comp}\;\Varid{tipo}\;\Varid{esq}\;\Varid{dir})\mathrel{=}\Varid{calcAux}\;\Varid{tipo}\;(\Varid{dimen}\;\Varid{esq})\;(\Varid{dimen}\;\Varid{dir}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\commentbegin   (0, 0)
...
dimen (Comp tipo esquerda direita) =
     ...
     where (ex, ey) = dimen esquerda
           (dx, dy) = dimen direita
           (tex, tey) = fst (last (collectLeafs esquerda))
           (tdx, tdy) = fst (last (collectLeafs direita))  \commentend}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{cai\char95 ex2}\mathbin{::}((\Conid{X}\;\Conid{Caixa}\;\Conid{Tipo}),\Conid{Origem}){}\<[E]%
\\
\>[B]{}\Varid{cai\char95 ex2}\mathrel{=}(\Varid{myex2},(\mathrm{0},\mathrm{0})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{pprint}\mathbin{::}\Conid{X}\;(\Conid{Caixa},\Conid{Origem})\;()\to \Conid{String}{}\<[E]%
\\
\>[B]{}\Varid{pprint}\;(\Conid{Unid}\;(((\anonymous ,(\Varid{x},\anonymous ))),\Varid{origem}))\mathrel{=}\text{\ttfamily \char34 //~Caixa:~\char34}\plus \Varid{x}\plus \text{\ttfamily \char34 ~\char34}\plus \Varid{show}\;\Varid{origem}\plus \text{\ttfamily \char34 ~|~-~|~\char34}{}\<[E]%
\\
\>[B]{}\Varid{pprint}\;(\Conid{Comp}\;\Varid{tipo}\;\Varid{esq}\;\Varid{dir})\mathrel{=}\Varid{pprint}\;\Varid{esq}\plus \Varid{pprint}\;\Varid{dir}{}\<[E]%
\\
\>[B]{}\mbox{\commentbegin -
...
calcOrigins' ((Comp tipo esq dir), origem) = (Comp () esq' dir')
                      where
                          ...
                          (a1,b1) = dimen esq
                          (a2,b2) = dimen dir- \commentend}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{calcOrigins'}\mathbin{::}((\Conid{X}\;\Conid{Caixa}\;\Conid{Tipo}),\Conid{Origem})\to \Conid{X}\;(\Conid{Caixa},\Conid{Origem})\;(){}\<[E]%
\\
\>[B]{}\Varid{calcOrigins'}\;(\Conid{Unid}\;\Varid{caixa},\Varid{origem})\mathrel{=}\Conid{Unid}\;(\Varid{caixa},\Varid{origem}){}\<[E]%
\\
\>[B]{}\Varid{calcOrigins'}\;((\Conid{Comp}\;\Varid{tipo}\;\Varid{esq}\;(\Conid{Unid}\;((\Varid{largura},\Varid{altura}),\Varid{x}))),\Varid{origem})\mathrel{=}(\Conid{Comp}\;()\;\Varid{esq'}\;\Varid{dir'}){}\<[E]%
\\
\>[B]{}\hsindent{23}{}\<[23]%
\>[23]{}\mathbf{where}{}\<[E]%
\\
\>[23]{}\hsindent{4}{}\<[27]%
\>[27]{}\Varid{esq'}\mathrel{=}\Varid{calcOrigins'}\;(\Varid{esq},\Varid{origem}){}\<[E]%
\\
\>[23]{}\hsindent{4}{}\<[27]%
\>[27]{}\Varid{dir'}\mathrel{=}\Varid{calcOrigins'}\;((\Conid{Unid}\;((\Varid{largura},\Varid{altura}),\Varid{x})),\Varid{calc}\;\Varid{tipo}\;\Varid{origem}\;(\Varid{fromIntegral}\;\Varid{largura},\Varid{fromIntegral}\;\Varid{altura})){}\<[E]%
\\
\>[B]{}\Varid{calcOrigins'}\;((\Conid{Comp}\;\Varid{tipo}\;\Varid{esq}\;\Varid{dir}),\Varid{origem})\mathrel{=}(\Conid{Comp}\;()\;\Varid{esq'}\;\Varid{dir'}){}\<[E]%
\\
\>[B]{}\hsindent{23}{}\<[23]%
\>[23]{}\mathbf{where}{}\<[E]%
\\
...
\\
\>[23]{}\hsindent{4}{}\<[27]%
\>[27]{}\Varid{dir'}\mathrel{=}\Varid{calcOrigins'}\;(\Varid{dir},\Varid{calc}\;\Varid{tipo}\;\Varid{origem}\;(\mathrm{0},\mathrm{0})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{calcOrigins}\mathbin{::}((\Conid{X}\;\Conid{Caixa}\;\Conid{Tipo}),\Conid{Origem})\to \Conid{X}\;(\Conid{Caixa},\Conid{Origem})\;(){}\<[E]%
\\
\>[B]{}\Varid{calcOrigins}\;(\Conid{Unid}\;\Varid{caixa},\Varid{origem})\mathrel{=}\Conid{Unid}\;(\Varid{caixa},\Varid{origem}){}\<[E]%
\\
\>[B]{}\Varid{calcOrigins}\;((\Conid{Comp}\;\Varid{tipo}\;\Varid{esq}\;\Varid{dir}),\Varid{origem})\mathrel{=}{}\<[E]%
\\
\>[B]{}\hsindent{23}{}\<[23]%
\>[23]{}\mathbf{let}\;\Varid{esq'}\mathrel{=}\Varid{calcOrigins}\;(\Varid{esq},\Varid{origem}){}\<[E]%
\\
\>[23]{}\hsindent{4}{}\<[27]%
\>[27]{}\Varid{dir'}\mathrel{=}\Varid{calcOrigins}\;(\Varid{dir},\Varid{origem}){}\<[E]%
\\
\>[B]{}\hsindent{23}{}\<[23]%
\>[23]{}\mathbf{in}\;(\Conid{Comp}\;()\;\Varid{esq'}\;\Varid{dir'}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment O princípio base é que a origem de um rectangulo corresponde ao seu canto inferior}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  esquerdo: a partir disto, dados dois rectangulos (a,b)}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  Quanto à função calc: considere duas caixas a) e b). Sabendo a posição absoluta}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment da caixa a), as suas dimensões, e a posição relativa da caixa b) em relação}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment à caixa a), a função, calc :: Tipo -> Origem -> (Float, Float) -> Origem,}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment determina onde colocar a caixa b), i.e. a sua posição absoluta.}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment (Float, Float) deveria ser (Int, Int)}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{calc}\mathbin{::}\Conid{Tipo}\to \Conid{Origem}\to (\Conid{Float},\Conid{Float})\to \Conid{Origem}{}\<[E]%
\\
\>[B]{}\Varid{calc}\;\Conid{Hb}\;(\Varid{x},\Varid{y})\;(\Varid{largura},\Varid{altura})\mathrel{=}(\Varid{x}\mathbin{+}\Varid{largura},\Varid{y}){}\<[E]%
\\
\>[B]{}\Varid{calc}\;\Conid{Ht}\;(\Varid{x},\Varid{y})\;(\Varid{largura},\Varid{altura})\mathrel{=}(\Varid{x}\mathbin{+}\Varid{largura},\Varid{y}\mathbin{+}\Varid{altura}){}\<[E]%
\\
\>[B]{}\Varid{calc}\;\Conid{H}\;(\Varid{x},\Varid{y})\;(\Varid{largura},\Varid{altura})\mathrel{=}(\Varid{x}\mathbin{+}\Varid{largura},\Varid{y}\mathbin{+}(\Varid{altura}\mathbin{/}\mathrm{2})){}\<[E]%
\\
\>[B]{}\Varid{calc}\;\Conid{Vd}\;(\Varid{x},\Varid{y})\;(\Varid{largura},\Varid{altura})\mathrel{=}(\Varid{x}\mathbin{+}\Varid{largura},\Varid{y}\mathbin{+}\Varid{altura}){}\<[E]%
\\
\>[B]{}\Varid{calc}\;\Conid{Ve}\;(\Varid{x},\Varid{y})\;(\Varid{largura},\Varid{altura})\mathrel{=}(\Varid{x},\Varid{y}\mathbin{+}\Varid{altura}){}\<[E]%
\\
\>[B]{}\Varid{calc}\;\Conid{V}\;(\Varid{x},\Varid{y})\;(\Varid{largura},\Varid{altura})\mathrel{=}(\Varid{x}\mathbin{+}(\Varid{largura}\mathbin{/}\mathrm{2}),\Varid{y}\mathbin{+}\Varid{altura}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment agrupa as caixas numa lista com as origens e caixas}{}\<[E]%
\\
\>[B]{}\Varid{agrup\char95 caixas}\mathbin{::}\Conid{X}\;(\Conid{Caixa},\Conid{Origem})\;()\to \Conid{Fig}{}\<[E]%
\\
\>[B]{}\Varid{agrup\char95 caixas}\mathrel{=}\bot {}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment segundo problema}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment mostra_caixas :: (L2D,Origem) -> IO ()--}{}\<[E]%
\\
\>[B]{}\Varid{mostra\char95 caixas}\mathrel{=}\bot {}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment auxiliar da função mostra_caixas}{}\<[E]%
\\
...
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{loop}\;(\Varid{e},\Varid{h},\Varid{s},\Varid{t})\mathrel{=}(\Varid{e}\mathbin{+}\Varid{h},\Varid{h}\mathbin{*}(\mathbin{-}\Varid{x}\mathbin{\uparrow}\mathrm{2})\mathbin{/}\Varid{s},\Varid{s}\mathbin{+}\Varid{t},\Varid{t}\mathbin{+}\mathrm{8}){}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{init}\mathrel{=}(\mathrm{1},\mathbin{-}\mathrm{1}\mathbin{/}\mathrm{2}\mathbin{*}(\Varid{x}\mathbin{\uparrow}\mathrm{2}),\mathrm{12},\mathrm{18}){}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{prj}\;(\Varid{e},\Varid{h},\Varid{s},\Varid{t})\mathrel{=}\Varid{e}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{9}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{outFS}\;(\Conid{FS}\;\Varid{l})\mathrel{=}\map \;\Varid{x}\;\Varid{l}{}\<[E]%
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}\mathbf{where}{}\<[E]%
\\
\>[7]{}\hsindent{2}{}\<[9]%
\>[9]{}\Varid{x}\;(\Varid{a},\Conid{File}\;\Varid{b})\mathrel{=}(\Varid{a},i_1\;\Varid{b}){}\<[E]%
\\
\>[7]{}\hsindent{2}{}\<[9]%
\>[9]{}\Varid{x}\;(\Varid{a},\Conid{Dir}\;\Varid{b})\mathrel{=}(\Varid{a},i_2\;\Varid{b}){}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  x (a, b) = (a, outNode b)}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{outNode}\;(\Conid{File}\;\Varid{conteudo})\mathrel{=}i_1\;\Varid{conteudo}{}\<[E]%
\\
\>[B]{}\Varid{outNode}\;(\Conid{Dir}\;\Varid{b})\mathrel{=}i_2\;\Varid{b}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{cataFS}\;\Varid{g}\mathrel{=}\Varid{g}\comp (\Varid{baseFS}\;\Varid{id}\;\Varid{id}\;(\Varid{cataFS}\;\Varid{g}))\comp \Varid{outFS}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{anaFS}\mathbin{::}(\Varid{c}\to [\mskip1.5mu (\Varid{a},\Varid{b}+\Varid{c})\mskip1.5mu])\to \Varid{c}\to \Conid{FS}\;\Varid{a}\;\Varid{b}{}\<[E]%
\\
\>[B]{}\Varid{anaFS}\;\Varid{g}\mathrel{=}\Varid{inFS}\comp (\Varid{baseFS}\;\Varid{id}\;\Varid{id}\;(\Varid{anaFS}\;\Varid{g}))\comp \Varid{g}{}\<[E]%
\\[\blanklineskip]%
