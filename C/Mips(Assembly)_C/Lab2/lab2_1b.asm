...
col:
	#mul $t5,$t3,4 #Green
	#mul $t6,$t4,4 #Red
	sll $t6,$t3,10 #Place the value of $t6 in the hexadecimal equivalent for red
	sll $t5,$t4,18 #Place the value of $t5 in the hexadecimal equivalent for green
	#Add the color that was organized in the last two lines
	add $t1,$t5,$t6 #"same"
